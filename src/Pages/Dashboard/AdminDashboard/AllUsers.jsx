  ...
  return (
    <div className="p-4 sm:p-8 bg-gradient-to-r from-yellow-50 to-yellow-100 min-h-screen">
      ...
      <div className="overflow-x-auto">
        <motion.table
          className="table-auto w-full border-collapse border border-gray-300 shadow-lg rounded-lg bg-white"
        ...
        >
          <thead>
            <tr className="bg-blue-200 text-yellow-800">
              ...
              <th className="border p-2 sm:p-4">Parcels Booked</th>
              <th className="border p-2 sm:p-4">Total Spent</th>
              <th className="border p-2 sm:p-4">Actions</th>
            </tr>
          </thead>
          <tbody>
            {currentUsers.map((user) => (
              ...
              >
                ...
                <td className="border p-2 sm:p-4">{user.phone || "N/A"}</td>
                <td className="border p-2 sm:p-4 text-center font-bold text-blue-600">
                  {user.parcelCount || "N/A"}
                </td>
                <td className="border p-2 sm:p-4 text-center font-bold text-green-500">
                  $ {user.totalSpent || "N/A"}
                </td>
